...
BOOST_AUTO_TEST_SUITE(NUPS_timing_valarray)
...
BOOST_AUTO_TEST_CASE(solve_random_octic_xxx_times)
{
	...
	std::valarray<std::complex<double> > solutions;
	std::valarray<double> expected_solutions, coefficients;
...
BOOST_AUTO_TEST_CASE(solve_random_octic_xxx_times_single_precision)
{
	...
	std::valarray<std::complex<float> > solutions;
	std::valarray<float> expected_solutions, coefficients;
...
BOOST_AUTO_TEST_SUITE(NUPS_linear_solvers_valarray)
...
{
	std::valarray<std::complex<double> > M(16);
	...
	std::valarray<std::complex<double> > b(4);
	...
	std::valarray<std::complex<double> > solution;
	solver::QuarticDenseLinear::Solve(solution, M, b);

	BOOST_CHECK_EQUAL(solution.size(),4);

	std::valarray<std::complex<double> > expected_soln(4);
...
BOOST_AUTO_TEST_CASE(linear_solve_8x8)
{
	...
	std::valarray<std::complex<double> > coeffs(8);
	...
	std::valarray<std::complex<double> > b(8);
	...
	std::valarray<std::complex<double> > expected_solution(8);
...
BOOST_AUTO_TEST_SUITE(NUPS_factorizations_valarray)
...
BOOST_AUTO_TEST_CASE(factor_8_into_4by4)
{
	...
	std::valarray<double > solution_r(4);
	std::valarray<double > solution_s(4);
	...
	std::valarray<double> coefficients(8); // omitting the 1, so it's monic

	FactorT::EvaluateF(coefficients,solution_r,solution_s);


	std::valarray<dbl> r, s;
	...
	std::valarray<dbl> computed_prod_coeffs;
...
BOOST_AUTO_TEST_SUITE(NUPS_solvers_valarray)
...
// 	std::valarray<std::complex<double> > solutions;
// 	std::valarray<std::complex<double> > coefficients(9);
...
// 	std::valarray<std::complex<double> > expected_solutions(8);
...
{
	std::valarray<std::complex<double> > solutions;
	std::valarray<std::complex<double> > coefficients(5);
	...
	std::valarray<std::complex<double> > expected_solutions(4);
...
{	
	std::valarray<std::complex<double> > solutions;
	std::valarray<std::complex<double> > coefficients(3);
